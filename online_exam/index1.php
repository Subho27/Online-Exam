...
<body>
	...
	<nav class="nav-section">
		<div class="container">
			<div class="nav-right">
                ...
                <a href=""><i class="fa fa-500px fa-user-circle-o"><?php echo " Welcome, ".$_SESSION['u_info']['name']." Sir";?></i></a>
                <a href="logout.php" class="font-weight-bold"><i class="fa fa-frown-o fa-500px"> Logout</i></a>
			</div>
			<ul class="main-menu">
				<li class="active"><a href="index1.php">Home</a></li>
				<li><a href="about_us_teacher.php">About Creators</a></li>
				<li><a href="take_a_test.php">Take A Test</a></li>
				<li><a href="send_results.php">RESULTS</a></li>
	...
	<!-- Fact section -->
	<section class="fact-section spad set-bg" data-setbg="img/fact-bg.jpg" style="width:100%;padding:0px;margin-top:30px;margin-bottom:20px">
		<div class="container">
			<div class="row">
