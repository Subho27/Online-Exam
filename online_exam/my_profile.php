		...
		<div class="container">
			<div class="map-section">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-info">
                   		<a href="update_teacher.php?pass=<?php echo $_SESSION['u_info']['pass'];?>"><button class="pull-right site-btn">Update Profile</button>
                        <a onClick='javascript:confirmation($(this));return false;' href="delete_teacher.php?pass=<?php echo $_SESSION['u_info']['pass'];?>"><button class="pull-left site-btn">Delete Profile</button></a>
